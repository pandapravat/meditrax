...
public class AutoCompleteTextField<T> extends Control {
     ...
     * types the ENTER key.
     */
    private final ObjectProperty<EventHandler<ActionEvent>> onSelectItem = new SimpleObjectProperty<>();
    
    /**
     * The selection handler associated with this list view, or null if no action
     * handler is assigned. The action handler is normally called when the user
     * types the ENTER key.
     */
    ...
    /**
     * Data provider when a key is pressed in the text box
     */
    private InstantDataProvider<T> dataProvider;
    
    private AfterSelectDataHadler<T> afterSelectDataHandler;
    ...
    public InstantDataProvider<T> getDataProvider() {
		return dataProvider;
	}

	public void setDataProvider(InstantDataProvider<T> dataProvider) {
		this.dataProvider = dataProvider;
	}
	

    public AfterSelectDataHadler<T> getAfterSelectDataHandler() {
		return afterSelectDataHandler;
	}

	public void setAfterSelectDataHandler(
			AfterSelectDataHadler<T> afterSelectDataHandler) {
		this.afterSelectDataHandler = afterSelectDataHandler;
	}
